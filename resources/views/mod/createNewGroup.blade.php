            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="FF6B6B" class="peer sr-only" checked>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="4D96FF" class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="FFD93D" class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="FF4444" class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="6BCB77" class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="9B59B6" class="peer sr-only">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="group_color" value="95A5A6" class="peer sr-only">
            ...
            <div>
                ...
                <div class="grid grid-cols-5 gap-3">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="group_logo" value="family" class="peer sr-only">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="group_logo" value="friends" class="peer sr-only">
                        <div class="p-3 rounded-lg border border-gray-200 text-gray-400 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-600 flex justify-center transition-all">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="group_logo" value="work" class="peer sr-only">
                        <div class="p-3 rounded-lg border border-gray-200 text-gray-400 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-600 flex justify-center transition-all">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="group_logo" value="emergency" class="peer sr-only">
                        <div class="p-3 rounded-lg border border-gray-200 text-gray-400 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-600 flex justify-center transition-all">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="group_logo" value="other" class="peer sr-only" checked>
                        <div class="p-3 rounded-lg border border-gray-200 text-gray-400 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-600 flex justify-center transition-all">
