<header class="w-full bg-white shadow-md flex items-center justify-between p-[1%] pl-[3%] pr-[3%]">
    <div class="flex items-center gap-3">
        <img src="{{ asset('images/mercury.png') }}" class="w-10 h-10 object-cover rounded-xl" alt="logo">
